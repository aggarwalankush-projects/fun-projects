...
public class GenerateTagsTwoB {

	String secondModel = "secondModel.bin";
	String testFile = "testingB.test";
	String predictions = "part-B-predictions.tsv";
	...
	public void doAllWork() throws Exception {
		...
		modelIn = new FileInputStream(secondModel);
	...
	public static void main(String[] args) {
		GenerateTagsTwoB generateTags = new GenerateTagsTwoB();
		try {
